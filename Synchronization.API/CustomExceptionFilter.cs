    ...
    public override void OnException(ExceptionContext context)
    {
        ...
        switch (context.Exception)
        {
            case DomainException domainException:
                _logger.LogInformation($"An {nameof(DomainException)} occurred. Error message: {domainException.Message}");
            ...
            case ApplicationException applicationException:
                _logger.LogInformation(
                    $"An {nameof(System.ApplicationException)} occurred. Error Code: {applicationException.Code}. Error message: {applicationException.Message}");
